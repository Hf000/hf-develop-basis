...
public class MybatisPaginationAspect {
    ...
    @Pointcut(value = "@annotation(com.hufei.cfg.annotation.MybatisPagination)")
    public void assess() {}
    ...
    public Object around(ProceedingJoinPoint joinPoint) {
        ...
        MybatisPagination paginationAnnotation = getPaginationAnnotation(joinPoint, paramMap, args);
        // 获取分页参数
    ...
    private Object pageResult(Object result) {
        ...
        if (result instanceof Page) {
            ...
            Page<?> page = om.convertValue(result, Page.class);
            return new PageInfo<>(page);
        } else if (result instanceof List) {
            return new PageInfo<>((List<?>)result);
        }
        throw new RuntimeException("MybatisPagination: the type of results returned by pagination is abnormal");
    }
    ...
    private void startPageProcess(Object pageNoParam, Object pageSizeParam) {
        ...
        if (StringUtils.isNumeric(String.valueOf(pageNoParam)) && StringUtils.isNumeric(String.valueOf(pageSizeParam))) {
            ...
            throw new RuntimeException("MybatisPagination: pagination parameter type is abnormal");
        }
    ...
    /**
     * 获取MybatisPagination注解对象, 并返回此方法的参数map
     * @param joinPoint 切点封装对象
     * @param paramMap 切点方法参数map
     * @param args 切点方法参数值
     * @return 分页注解对象
     */
    private MybatisPagination getPaginationAnnotation(ProceedingJoinPoint joinPoint, Map<String, Object> paramMap, Object[] args) {
        // 获取切点的Signature
        ...
        // 获取方法上的注解
        return method.getAnnotation(MybatisPagination.class);
    }
