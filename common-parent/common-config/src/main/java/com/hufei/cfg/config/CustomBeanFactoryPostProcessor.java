...
//        beanDefinitionBuilder.setDestroyMethodName("destroyMethodName");
    ...
    private Set<Class<?>> getAnnotationClass() {
        ...
        if (StringUtils.isNotBlank(scannerPackages) && !StringUtils.containsIgnoreCase(scannerPackages, CfgConstant.NULL_STRING)) {
            // 扫描指定路径下的包
