...
import com.hufei.cfg.utils.TimeUtil;
...
public class RequestParameterAspect {
    ...
    /**
     * 拦截com.hufei包及其子包下面所有以Controller结尾的类里面的所有方法
     */
    @Pointcut("execution(public * com.hufei..*Controller.*(..))")
    ...
    public Object handleControllerMethod(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        // 获取当前请求的指定参数
        String requestId = request.getParameter(CfgConstant.REQUEST_ID);
        // 获取方法传参
