package com.hufei.ueh.handlers;

import com.hufei.cp.response.ResponseVO;
import com.hufei.ueh.cusexception.CheckedException;
...
public class GlobalExceptionResolver {
    ...
    public ResponseVO<Void> throwableHandlerMethod(Throwable e) {
        ...
        responseVO.setResponseCode(ExceptionStates.SYSTEMERROR.getCode());
        responseVO.setResponseMsg(ExceptionStates.SYSTEMERROR.getMsg());
        return responseVO;
    }
